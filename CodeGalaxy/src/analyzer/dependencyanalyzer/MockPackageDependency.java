 ...
 * Mock class for Package Dependency Info.
 */

public class MockPackageDependency extends GenericDependency{
	...
	public MockPackageDependency(){
	}
	
	public MockPackageDependency(int numUsedby, int numInt){
